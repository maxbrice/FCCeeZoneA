 ...
 */
UCLASS()
class DIGITALTWINTOOLS_API UQuickActorActionsWidget : public UEditorUtilityWidget
{
	GENERATED_BODY()
...
#pragma region 3DXMLImport
	
	
	UFUNCTION(BlueprintCallable, Category = "3DXMLImport")
	bool Import3DXMLfiles(const FString& FilePath);
